...
<template>
  <section class="auth">
    ...
    <div class="auth-form">
      <h2>注册时迁账号</h2>
      <el-form :model="form" label-position="top" @submit.prevent="register">
        ...
        <el-form-item label="确认密码"><el-input v-model="form.confirmPassword" type="password" placeholder="再次输入密码" show-password /></el-form-item>
        <el-button type="primary" native-type="submit" class="full" :loading="submitting">注册并登录</el-button>
      </el-form>
