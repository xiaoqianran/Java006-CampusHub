...
INSERT INTO t_resource (id, user_id, title, description, category_id, file_url, file_size, file_type, download_count, version, status, deleted)
VALUES
    (1, 2, '计算机网络实验三：路由协议配置', '包含 RIP、OSPF 路由配置步骤、拓扑图与常见错误排查。', 1, 'https://example.com/resources/network-lab-3.pdf', 2456789, '实验报告', 426, 1, 1, 0),
    (2, 2, '数据结构期末复习提纲与真题解析', '覆盖线性表、树、图、排序、查找等核心知识点。', 1, 'https://example.com/resources/data-structure-review.pdf', 1945600, '复习资料', 338, 1, 0, 0),
    (3, 2, '高等数学上册重点公式速查表', '极限、导数、积分、级数常见公式与题型归纳。', 2, 'https://example.com/resources/math-formula.pdf', 884736, '公式整理', 880, 1, 1, 0),
    (4, 2, '大学英语四级高频词汇与作文模板', '词汇分组、作文句型、听力训练方法。', 3, 'https://example.com/resources/cet4-template.pdf', 1024000, '考试资料', 220, 1, 2, 0),
    (5, 2, 'Java Spring Boot 项目脚手架说明', '适合课程设计使用的后端项目结构、常用依赖与接口示例。', 1, 'https://example.com/resources/spring-boot-starter.zip', 4096000, '项目模板', 502, 1, 1, 0),
    (6, 1, '考研数学一真题分类精讲', '按知识点拆分近年真题，并配有解题思路。', 4, 'https://example.com/resources/postgraduate-math.pdf', 3072000, '真题解析', 420, 1, 1, 0)
ON DUPLICATE KEY UPDATE
